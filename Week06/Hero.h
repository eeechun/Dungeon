...
public:
	...
	// Intent: Incrementally move the elements.
	// Pre: Elements cannot move.
	// Post: Incrementally move the elements.
	...
	// Intent: Jump hero's position directlly.
	// Pre: Hero can move only one unit once.
	// Post: Hero can move to the destination directlly.
