...
//==================================================================
{
	...
	// randomly set the two kinds of creatures' position and push back to Creature vector
	Creature* creature1 = new Creature1();
	Position cPos1 = getValidRandomPos();
	validFlags[cPos1.y][cPos1.x] = false;
	creature1->setPos(cPos1);
	gCreatures.push_back(creature1);

	Creature* creature2 = new Creature2();
	Position cPos2 = getValidRandomPos();
	validFlags[cPos2.y][cPos2.x] = false;
	creature2->setPos(cPos2);
