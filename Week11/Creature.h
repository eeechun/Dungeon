...
// Hero's health minus 10 when it was attacked by Creature1 (icon : x)
...
// Hero's level decreased by 1 when it was attacked by Creature2 (icon : X)
class Creature2 :public Creature
{
public:
	Creature2()
	{
